...
namespace svd{
    ...
    void initialPQ(int itemNum, int userNum,int dim)
    {
        using namespace svd;
        int i;
        //@TODO ²»ÖªµÀÊÇ·ñÄÜÕë¶Ô³õÊ¼»¯µÄ¹ý³Ì×öÒ»Ð©ÓÅ»¯
               ...
               int maxStep=60,double slowRate=1,bool isUpdateBias=true)
    {
        ...
        float pui = 0.0 ; // Ô¤²âµÄu¶ÔiµÄ´ò·Ö
        double preRmse = 1000000000000.0; //ÓÃÓÚ¼ÇÂ¼ÑµÁ·¼¯ÉÏÒ»´Îµü´úµÄrmse£¬×÷ÎªÖÕÖ¹Ìõ¼þµÄÒ»ÖÖ£¬Èç¹ûrmseÉÏÉýÁË£¬ÔòÍ£Ö¹
